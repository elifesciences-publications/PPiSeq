...
### SD2
PPI_lineages = dataFrameReader_T("Paper_data/Lineage_barcode_fitness_files/SD2_PPI_barcodes_fitness_counts.csv")
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/SD2_mean_fitness_positive.csv") # 1459163
...
##FK506
PPI_lineages = dataFrameReader_T("Paper_data/Lineage_barcode_fitness_files/FK506_PPI_barcodes_fitness_counts.csv")
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/FK506_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
##H2O2
PPI_lineages = dataFrameReader_T("Paper_data/Lineage_barcode_fitness_files/H2O2_PPI_barcodes_fitness_counts.csv")
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/H2O2_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/Hydroxyurea_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/NaCl_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
##Forskolin
PPI_lineages = dataFrameReader_T("Paper_data/Lineage_barcode_fitness_files/Forskolin_PPI_barcodes_fitness_counts.csv")
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/Forskolin_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/Raffinose_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/Doxorubicin_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
...
DMSO_mean = csvReader_T("Paper_data/PPI_mean_fitness_calling_files/Cold_16C_mean_fitness_positive.csv") 
PPI_fit_final_data = Create_replicate_matrix(PPI_lineages, DMSO_mean)
