...
ggplot(stability_bin_degree, aes(x = degree, fill = label, col = label))+
        ...
        theme(legend.key = element_blank(), legend.position = c(0.65,0.9),
...
ggsave("Working_figure/Figure3_accessory_PPIs/accessory_PPI/Neighbor_stability_score_environment_bin.pdf", width =4, height =4)
