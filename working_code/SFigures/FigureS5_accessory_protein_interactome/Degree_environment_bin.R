...
#degree_protein_match = degree_protein[match(vScore_protein[,1], degree_protein[,1]),]
#vScore_protein_degree= cbind(vScore_protein, degree_protein_match[,2])
#max(as.numeric(vScore_protein_degree[,2])) # 3
#PPI_degree_mean = rep(0, nrow(vScore_PPI))
