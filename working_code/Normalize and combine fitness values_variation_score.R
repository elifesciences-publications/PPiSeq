...
PPI_dup = mark_duplicates_fast(PPI_fit_norm[,1]) # 13650
PPI_dup_01 = c("0", "0")
...
PPI_fit_norm = csvReader_T("Pos_PPI_normalized_fit.csv") # 14446
PPI_count = csvReader_T("PPI_environment_count_summary.csv") 
PPI_dup = mark_duplicates_fast(PPI_fit_norm[,1]) # 13650
PPI_dup_01 = c("0", "0")
for(i in 1:nrow(PPI_count)){
...
cor(environment_number, variation_score, method="spearman") # -0.9381309
...
cor(environment_number, variation_score, method="spearman") # -0.6991184
...
cor(environment_number, variation_score, method="spearman") # -0.7231988
