...
csvWriter(matrix_count_1, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_1.csv")
csvWriter(matrix_count_2, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_2.csv")
csvWriter(matrix_count_3, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_3.csv")
csvWriter(matrix_count_4, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_4.csv")
csvWriter(matrix_count_5, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_5.csv")
csvWriter(matrix_count_6, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_6.csv")
csvWriter(matrix_count_7, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_7.csv")
csvWriter(matrix_count_8, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_8.csv")
csvWriter(matrix_count_9, "Working_data_2/Accumulated_PPI_SD_calling/PPI_number_environment_accumulation_all_order_9.csv")

##### Make a plot to show these accumulated counts
setwd("~/Dropbox/PPiSeq_02/Working_data_2/Accumulated_PPI_SD_calling/")
