...
length(which(homo_plot_matrix_large$Correlation > 0 & homo_plot_matrix_large$Difference_amount > 0)) #790
length(which(homo_plot_matrix_large$Correlation > 0 & homo_plot_matrix_large$Difference_amount < 0)) #350
length(which(homo_plot_matrix_large$Correlation < 0 & homo_plot_matrix_large$Difference_amount < 0)) #37
length(which(homo_plot_matrix_large$Correlation < 0 & homo_plot_matrix_large$Difference_amount > 0)) #62
...
ggsave("~/Desktop/Cor_abundance/Figure5B_abudance_change_versus_correlation_homo_dimer_>5_PPI_>0.5_dot.pdf", width = 6, height =5)
...
ggplot() +
  ...
  theme(axis.text.x = element_text(size = 10, color = "black"),
        axis.text.y.left = element_text(size = 10, color = "black"))
ggsave("~/Desktop/Cor_abundance/abudance_change_versus_correlation_homo_dimer_YML017W_dot.pdf", width = 5, height =5)
