...
setwd("/Volumes/zmliu_02/PPiseq_02/Combine_environments/lineage_fitness_files/")
...
setwd("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Promiscuous_PPIs/")
...
colnames(matrix_bad) = c("PPI","Positive_sum","SD","H2O2", "HU", "Dox", "Forskolin",
...
setwd("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/")
...
promiscuous_protein = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Promiscuous_PPIs/Promiscuous_protein_summary.csv")
...
csvWriter(DMSO_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/SD_Pos_PPI_real.csv")
...
csvWriter(H2O2_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/H2O2_Pos_PPI_real.csv")
csvWriter(HU_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Hydroxyurea_Pos_PPI_real.csv")
csvWriter(Dox_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Doxorubicin_Pos_PPI_real.csv")
csvWriter(Forskolin_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Forskolin_Pos_PPI_real.csv")
csvWriter(NaCl_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/NaCl_Pos_PPI_real.csv")
csvWriter(Raffinose_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Raffinose_Pos_PPI_real.csv")
csvWriter(FK506_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/FK506_Pos_PPI_real.csv")
csvWriter(cold_pos_filter, "/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Cold_16C_Pos_PPI_real.csv")


#(3) Make a file that contain mean fitness, sd, p.value, Q.value, positive (1: positive), control(1:control)
setwd("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_multiple_files/")
...
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/SD_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/SD_Pos_PPI_real.csv")
...
#DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/SD2_Pos_PPI_control.csv")
#DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/SD2_Pos_PPI_real.csv")
#output = "SD2_mean_fitness_positive.csv"
#Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### H2O2
DMSO = dataFrameReader_T("H2O2_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/H2O2_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/H2O2_Pos_PPI_real.csv")
output = "H2O2_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### HU
DMSO = dataFrameReader_T("Hydroxyurea_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/Hydroxyurea_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Hydroxyurea_Pos_PPI_real.csv")
output = "Hydroxyurea_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Dox
DMSO = dataFrameReader_T("Doxorubicin_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/Doxorubicin_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Doxorubicin_Pos_PPI_real.csv")
output = "Doxorubicin_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Forskolin
DMSO = dataFrameReader_T("Forskolin_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/Forskolin_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Forskolin_Pos_PPI_real.csv")
output = "Forskolin_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Raffinose
DMSO = dataFrameReader_T("Raffinose_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/Raffinose_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Raffinose_Pos_PPI_real.csv")
output = "Raffinose_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### NaCl
DMSO = dataFrameReader_T("NaCl_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/NaCl_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/NaCl_Pos_PPI_real.csv")
output = "NaCl_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### 16C
DMSO = dataFrameReader_T("Cold_16C_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/Cold_16C_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/Cold_16C_Pos_PPI_real.csv")
output = "Cold_16C_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### FK506
DMSO = dataFrameReader_T("FK506_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/PPI_each_environment/FK506_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq_02/Combine_environments/Positive_PPI_remove_promiscuous/FK506_Pos_PPI_real.csv")
