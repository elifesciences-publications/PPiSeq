...
HU = dataFrameReader_F("HU_known_PPI_fitness_barcodes_sorted.csv")
...
Dox = dataFrameReader_F("Dox_known_PPI_fitness_barcodes_sorted.csv")
...
cold = dataFrameReader_F("16C_known_PPI_fitness_barcodes_sorted.csv")
...
setwd("/Volumes/zmliu_02/PPiseq/Combine_environments/Promiscuous_PPIs/")
...
setwd("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/")
DMSO_pos = csvReader_T("SD_Pos_PPI_real.csv") # 5302
DMSO_2_pos = csvReader_T("SD2_Pos_PPI_real.csv") # 5322
H2O2_pos = csvReader_T("H2O2_Pos_PPI_real.csv") # 5722
HU_pos = csvReader_T("HU_Pos_PPI_real.csv") # 7941
Dox_pos = csvReader_T("Dox_Pos_PPI_real.csv") # 4050
Forskolin_pos = csvReader_T("Forskolin_Pos_PPI_real.csv") # 4385
NaCl_pos = csvReader_T("NaCl_Pos_PPI_real.csv") # 2594
Raffinose_pos = csvReader_T("Raffinose_Pos_PPI_real.csv") # 4694
FK506_pos = csvReader_T("FK506_Pos_PPI_real.csv") #3454
Cold_pos = csvReader_T("16C_Pos_PPI_real.csv") # 3638
promiscuous_protein = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Promiscuous_PPIs/Promiscuous_protein_summary.csv")
...
DMSO_pos_filter = remove_PPI_protein(DMSO_pos, promiscuous_protein_chosen) # 5145 from 5302
DMSO_2_pos_filter = remove_PPI_protein(DMSO_2_pos, promiscuous_protein_chosen) # 5317 from 5322
H2O2_pos_filter = remove_PPI_protein(H2O2_pos, promiscuous_protein_chosen) # 5712 from 5722
HU_pos_filter = remove_PPI_protein(HU_pos, promiscuous_protein_chosen) # 6565 from 7941
Dox_pos_filter = remove_PPI_protein(Dox_pos, promiscuous_protein_chosen) # 3770 from 4050
Forskolin_pos_filter = remove_PPI_protein(Forskolin_pos, promiscuous_protein_chosen) # 4204 from 4385
NaCl_pos_filter = remove_PPI_protein(NaCl_pos, promiscuous_protein_chosen) # 2482 from 2594
Raffinose_pos_filter = remove_PPI_protein(Raffinose_pos, promiscuous_protein_chosen) # 4691 from 4694
FK506_pos_filter = remove_PPI_protein(FK506_pos, promiscuous_protein_chosen) # 3447 from 3454
cold_pos_filter = remove_PPI_protein(Cold_pos, promiscuous_protein_chosen) # 3589 from 3638

csvWriter(DMSO_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/SD_Pos_PPI_real.csv")
csvWriter(DMSO_2_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/SD2_Pos_PPI_real.csv")
csvWriter(H2O2_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/H2O2_Pos_PPI_real.csv")
csvWriter(HU_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Hydroxyurea_Pos_PPI_real.csv")
csvWriter(Dox_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Doxorubicin_Pos_PPI_real.csv")
csvWriter(Forskolin_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Forskolin_Pos_PPI_real.csv")
csvWriter(NaCl_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/NaCl_Pos_PPI_real.csv")
csvWriter(Raffinose_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Raffinose_Pos_PPI_real.csv")
csvWriter(FK506_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/FK506_Pos_PPI_real.csv")
csvWriter(cold_pos_filter, "/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Cold_16C_Pos_PPI_real.csv")


#(3) Make a file that contain mean fitness, sd, p.value, Q.value, positive (1: positive), control(1:control)
setwd("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_multiple_files/")
Combine_matrix = function(DMSO, DMSO_pos_control, DMSO_pos_real, output){
        ...
        colnames(DMSO_label) = c("PPI", "Number_of_barcodes", "Mean_fitness","SD", "P_value", "FDR_adjusted_P_value", "Positive")
        csvWriter(DMSO_label, output)
}

#### SD
DMSO = dataFrameReader_T("SD_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/SD_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/SD_Pos_PPI_real.csv")
...
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/H2O2_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/H2O2_Pos_PPI_real.csv")
output = "H2O2_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### HU
DMSO = dataFrameReader_T("HU_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/HU_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Hydroxyurea_Pos_PPI_real.csv")
output = "Hydroxyurea_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Dox
DMSO = dataFrameReader_T("Dox_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/Dox_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Doxorubicin_Pos_PPI_real.csv")
output = "Doxorubicin_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Forskolin
DMSO = dataFrameReader_T("Forskolin_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/Forskolin_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Forskolin_Pos_PPI_real.csv")
output = "Forskolin_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### Raffinose
DMSO = dataFrameReader_T("Raffinose_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/Raffinose_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Raffinose_Pos_PPI_real.csv")
output = "Raffinose_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### NaCl
DMSO = dataFrameReader_T("NaCl_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/NaCl_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/NaCl_Pos_PPI_real.csv")
output = "NaCl_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### 16C
DMSO = dataFrameReader_T("16C_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/16C_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/Cold_16C_Pos_PPI_real.csv")
output = "Cold_16C_mean_fitness_positive.csv"
Combine_matrix(DMSO, DMSO_pos_control, DMSO_pos_real, output)

### FK506
DMSO = dataFrameReader_T("FK506_PPI_multiple_p.values.csv")
DMSO_pos_control = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/PPI_each_environment/FK506_Pos_PPI_control.csv")
DMSO_pos_real = csvReader_T("/Volumes/zmliu_02/PPiseq/Combine_environments/Positive_PPI_remove_promiscuous/FK506_Pos_PPI_real.csv")
