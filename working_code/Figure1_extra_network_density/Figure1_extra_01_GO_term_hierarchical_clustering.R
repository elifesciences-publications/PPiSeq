...
ggsave("Working_figure/Figure1_extra/Dendrogram_BP_GO_pair_cluster_truncated.pdf", width = 4, height =12)
...
label_GO = label(dendr)
GO_order = label_GO[order(label_GO$x),]
csvWriter(GO_order$label, "Working_data_2/PPI_pair_GO/environment/GO_BP_order_chosen.txt")
