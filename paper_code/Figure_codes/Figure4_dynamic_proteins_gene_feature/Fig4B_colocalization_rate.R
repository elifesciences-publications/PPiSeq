...
PPI_count_filter = read.csv("Datasets_generated_by_preprocessing/PPI_environment_count_summary_SD_merge_filter.csv")
PPI_variation = read.csv("Datasets_generated_by_preprocessing/Variation_score_PPI_environment_neg_zero_SD_merge_filter.csv")
...
#Calculate the percent colocalization
...
pdf(file = "Figures/Figure4/Figure4B_colocalization_rate.pdf", height = 7, width = 4 )
