...
SD1_lineage = csvReader_T("Lineage_barcode_fitness_files/SD_PPI_barcodes_fitness_counts.csv")
SD2_lineage = csvReader_T("Lineage_barcode_fitness_files/SD2_PPI_barcodes_fitness_counts.csv")
...
csvWriter(matrix_final, "Figures/Figure1/Figure1F_SD_replciates.csv")

matrix_final = dataFrameReader_T("Figures/Figure1/Figure1F_SD_replciates.csv")
...
ggsave("Figures/Figure1/Figure1F_correlation_SD_replicates_hexagonlot.pdf", height = 4, width = 4)
