...
bait_ORF_fragment = csvReader_T("PPiseq_PPI_barcodes/Bait_ORF_DHFR3_control.csv")
prey_ORF_fragment = csvReader_T("PPiseq_PPI_barcodes/DHFR12_prey_ORF_control.csv")
...
DMSO_mean = csvReader_T("PPI_mean_fitness_calling_files/SD_mean_fitness_positive.csv") # 1448699
DMSO_pos = DMSO_mean[which(DMSO_mean[,8] == 1),] # 5286
#Here I only choose these reported PPIs in this figure
PPI_reported = csvReader_T("Outsourced_datasets/BIOGRID/multiple_validated_PPI.csv") # summary of reported PPIs in BIOGRID 
...
ggsave("Figures/Figure1/Figure1D_Calling_PPIs_violin_jitter_dot.pdf", width= 4, height = 2.5)
