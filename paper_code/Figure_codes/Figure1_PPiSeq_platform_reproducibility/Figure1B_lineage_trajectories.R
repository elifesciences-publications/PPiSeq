...
PPiseq_control = csvReader_T("PPiseq_PPI_barcodes/PPiseq_control_barcodes.csv")
...
Lineage_plot(PPI_lineages_final_transform, "Figures/Figure1/Figure1B_6000_representative_lineages.pdf")
